...
public interface RegistrationsRepository extends CrudRepository<UserModel, Integer> {
	...
	@Transactional
	@Modifying
	@Query(value = "UPDATE UserModel SET matricula = :matricula, rg = :rg, data_nascimento = :data_nascimento, nome_completo = :nome_completo, sexo = :sexo, endereço = :endereco, plano_academia = :plano_academia, status_academia = :status_academia WHERE id = :id", nativeQuery = true)
